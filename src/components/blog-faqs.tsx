import { localizedAnswer, localizedQuestion, type Faq } from "@/lib/blog";
...
export function BlogFaqs({ faqs }: { faqs: Faq[] }) {
  ...
  return (
    <div className="mt-16 border-t border-white/10 pt-12">
      <h2 className="font-serif text-2xl text-white sm:text-3xl">{t("blog.faqsHeading")}</h2>
